...
| 👉 **Live demo:** | <https://market-toolkit-demo.vercel.app> |
|-------------------|------------------------------------------------|
...
```
market-toolkit/
├─ market_toolkit.py          # ← this file (core library)
├─ pyproject.toml             # build metadata (optional)
├─ README.md                  # symlink to this doc‑string on install
├─ tests/
...
*(The remainder of this file is the implementation; scroll past if you’re only reading the docs.)*
"""
# ————————————————————————————————————————————
...
# (rest of previous implementation left exactly as‑is)
